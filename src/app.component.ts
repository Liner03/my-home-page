...
export class AppComponent {
  ...
  setView(view: View) {
    ...
    if (currentView === view) {
      ...
      const currentIndex = navIds.indexOf(currentView as 'about' | 'websites' | 'notes');
      const newIndex = navIds.indexOf(view as 'about' | 'websites' | 'notes');
